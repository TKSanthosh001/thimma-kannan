        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-10">
          ...
          <div className="space-y-4">
            ...
            <div className="pt-2">
              <a
                ...
                className="btn btn-whatsapp text-xs py-2 px-3 inline-flex items-center gap-2 font-bold"
              >
          ...
          <div>
            ...
            <ul className="space-y-2 text-xs">
              ...
              <li>
                <a href="#about" onClick={(e) => scrollToSection(e, 'about')} className="text-secondary hover:text-saffron transition-colors">{t.nav.about}</a>
              </li>
              <li>
              ...
              <li>
                <a href="#packages" onClick={(e) => scrollToSection(e, 'packages')} className="text-secondary hover:text-saffron transition-colors">{t.nav.packages}</a>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-xs text-secondary">
              <li className="flex items-start gap-2.5">
                ...
                <a href={`tel:${businessConfig.phone}`} className="hover:text-saffron transition-colors font-medium">
          ...
          <div>
            ...
            <div className="flex items-start gap-2.5 text-xs text-secondary mb-3">
